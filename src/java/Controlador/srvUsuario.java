...
public class srvUsuario extends HttpServlet
{
    ...
    private void verificar(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        if (usuario != null && usuario.getCargo().getNombreCargo().equals("ADMINISTRADOR"))
        {
            ...
            this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/admin/index.jsp").forward(request, response);
        }
        else if(usuario != null && usuario.getCargo().getNombreCargo().equals("ESTUDIANTE"))
        {
           sesion = request.getSession();
           sesion.setAttribute("estudiante", usuario);
           this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/alum/formAlumno.jsp").forward(request, response); 
        }
        else
        {
